(function ($) {
  ...
  $('.card-body a.btn.btn-primary[name=schedule]').click(
    function (e) {
      e.preventDefault();
  ...
  // Non internal links were asked to open in new windows/tabs
...
var centerLat = 39.414928;
var centerLong = -76.613576;
